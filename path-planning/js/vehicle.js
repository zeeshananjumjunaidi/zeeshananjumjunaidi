...
class Vehicle {
    ...
    constructor(x, y, heading, tx = 0, ty = 0, th = 0) {
        ...
        this.vLCircle = createVector();
        this.vRCircle = createVector();
        this.tLCircle = createVector();
        this.tRCircle = createVector();
    ...
    generateDrivingPath() {
        if (this.pathDataList.length > 0) {
            ...
            let currentPosition = createVector(this.position.x, this.position.y);
